...
echo "Transfering Data to PGSQL 2nd server"

sshpass -p 'DuoS123' rsync -aruv /home/backups/database/postgresql/*  root@192.168.51.251:/home/backups/database/postgresql/
